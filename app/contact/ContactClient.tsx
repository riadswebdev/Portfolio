  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg
          className="w-4 h-4 text-zinc-100 group-hover:text-white"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
          <path
    ...
    <div className="relative min-h-screen font-sans  selection:text-cyan-400 flex flex-col justify-between overflow-hidden">
      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          >
            <div
              className="p-6 sm:p-8 rounded-3xl border border-white/10 space-y-6 shadow-2xl backdrop-blur-md"
            ...
            >
              ...
              <div className="space-y-3">
                {contactInfo.map((info, idx) => (
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-xl border flex items-center justify-center shrink-0 ${info.bgColor} group-hover:scale-105 transition-transform`}
                    >
                      {info.icon}
                    </div>
          ...
          >
            <div
              className="p-6 sm:p-10 rounded-3xl border border-white/10 space-y-6 shadow-2xl backdrop-blur-md"
              style={{ background: "rgba(4, 6, 12, 0.58)" }}
            >
              <div>
                ...
                <p className="text-xs text-zinc-300 font-light mt-1">
                  Have a question or proposal? Send a message directly to my
                  inbox.
                </p>
              </div>
              ...
              {submitted && (
                <div className="p-4 rounded-2xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs font-medium flex items-center gap-2 shadow-lg shadow-cyan-500/10">
                  ...
                  Thank you! Your message has been sent successfully to my
                  inbox.
                </div>
              )}
