...
const SkillsOverview = dynamic(() => import("./components/SkillsOverview"), {
  ssr: false,
  loading: () => null,
});
  ...
  return (
    <div className="min-h-screen text-zinc-100 font-sans selection:bg-blue-500/30 selection:text-blue-400">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 px-6 max-w-7xl mx-auto overflow-hidden">
        {/* Ambient glow orb */}
        <div className="absolute top-1/3 left-1/4 w-175 h-175 bg-linear-to-tr from-blue-600/10 via-indigo-600/8 to-purple-600/8 rounded-full blur-3xl pointer-events-none -z-10" />
        <div className="absolute top-1/2 right-0 w-100 h-100 bg-linear-to-bl from-cyan-600/8 to-transparent rounded-full blur-3xl pointer-events-none -z-10" />
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-blue-500/8 border border-blue-500/20 text-xs font-mono text-blue-400 backdrop-blur-sm"
            >
            ...
            <motion.div
              variants={fadeInUp}
              className="pt-6 grid grid-cols-3 gap-6 max-w-xl"
            >
              {[
          ...
          {[
            {
              ...
              desc: "Mobile to 4K Displays",
            },
            {
              metric: "22+",
              label: "Tech Stack Tools",
              desc: "React, Next.js, Node, MongoDB",
            },
            {
              metric: "Full Stack",
              label: "End-to-End Solutions",
              desc: "Frontend UI to REST APIs",
            },
            {
              metric: "AI-Powered",
              label: "Modern Workflow",
              desc: "Rapid & Reliable Building",
            },
          ].map((item, index) => (
            <div
              key={index}
              className="p-4 rounded-2xl bg-zinc-900/10 border border-zinc-800/60 text-center space-y-1 hover:border-cyan-500/30 transition-colors"
            >
              <p className="text-2xl sm:text-3xl font-black bg-linear-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                {item.metric}
              </p>
      ...
      <section id="skills" className="px-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-sm leading-relaxed">
            Building complex, responsive applications with a focus on modern web
            standards and smooth interactions.
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            <motion.div
              key={i}
              variants={fadeInUp}
              className={`relative p-6 rounded-2xl bg-linear-to-br ${item.accent} border border-zinc-800/60 ${item.border} hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group backdrop-blur-sm overflow-hidden`}
            >
      ...
      <section id="projects" className="px-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-sm leading-relaxed">
            A selection of full-stack web applications fetched directly live
            from GitHub.
          </p>
        </motion.div>

        <GithubProjects username="riadswebdev" maxItems={3} />
      </section>
      ...
      <section className="py-14 sm:py-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-white text-sm leading-relaxed">
              I combine traditional computer science fundamentals with modern AI
              tooling (Cursor, Claude 3.7, ChatGPT) to build software
              significantly faster without sacrificing code quality.
            </p>
      ...
      <section id="contact" className="py-14 sm:py-16 px-6 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            {/* Lazy background video - loads only when visible, uses metadata preload and poster if needed */}
            <BackgroundVideo
          ...
          <div className="absolute inset-0 rounded-3xl bg-linear-to-r from-cyan-500/10 via-blue-500/5 to-purple-500/10 pointer-events-none" />
          ...
          <div className="max-w-2xl space-y-7 relative z-10">
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed font-light">
              Open to full-time roles, contract work, or technical
      ...
      <motion.button
        ...
        style={{
          ...
          boxShadow:
            showScrollTop ?
              "0 0 24px rgba(34,211,238,0.45), 0 4px 20px rgba(99,102,241,0.3)"
            : "none",
